...
export default function Page() {
  ...
  return (
    <section className="flex min-h-[100vh] relative">
      ...
      {loading ?
        <div className='flex bg-[#F6F7F9] relative justify-center items-center w-full min-h-[30vh]'><i className="ri-reset-right-fill text-[#3563E9] text-3xl animate-spin-fast"></i></div> :
        <>{car ? <>
        ...
        </> : <div className="bg-[#F6F7F9] relative h-screen w-full flex justify-center items-center"><h1 className="text-xl font-semibold text-red-600">You have not rented the car.</h1></div>}</>}
    </section>
  );
};