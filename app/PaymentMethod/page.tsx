...
export default function Page() {
  ...
  if (!car) {
    return <div className='flex relative justify-center items-center min-h-[60vh] px-2'><h1 className="text-red-600 text-base text-center">Please select a car to rent before proceeding to the payment page.</h1></div>
  }
